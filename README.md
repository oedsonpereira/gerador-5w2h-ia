...
5W2H é uma metodologia de gestão utilizada para planejamento estratégico e análise de problemas:
...
- **How much** (Quanto custa) - Qual o custo estimado?
...
### 1️⃣ **Baixar a Ferramenta**

```bash
# Clone o repositório
git clone https://github.com/oedsonpereira/gerador-5w2h-ia.git
```

Ou baixe o arquivo `5w2h-generator-ai.html` diretamente.

### 2️⃣ **Obter API Key da Anthropic**
...
> **💰 Custo:** Anthropic oferece **$5 em créditos gratuitos**. Cada plano custa ~$0.01-0.02

### 3️⃣ **Configurar e Usar**

1. Abra `5w2h-generator-ai.html` no navegador
2. Cole sua API Key no campo indicado
3. Clique em **Salvar**
4. Descreva seu problema em detalhes
5. Clique em **Gerar Plano 5W2H com IA**
...
baixa e perdemos 2 clientes importantes.
```

**Plano 5W2H gerado:**

✅ **What:** Implementar programa de capacitação em vendas consultivas  
✅ **Why:** Recuperar performance e aumentar motivação da equipe  
✅ **Where:** Sede da empresa e plataforma online  
✅ **When:** 90 dias (3 fases)  
✅ **Who:** Diretor Comercial + Consultoria especializada  
✅ **How:** Diagnóstico → Treinamento → Implementação CRM → Acompanhamento  
✅ **How Much:** R$ 87.000 (consultoria + CRM + reestruturação)
...
- 🐛 [Reporte um Bug](https://github.com/oedsonpereira/gerador-5w2h-ia/issues)
- 💡 [Sugira uma Feature](https://github.com/oedsonpereira/gerador-5w2h-ia/issues)
